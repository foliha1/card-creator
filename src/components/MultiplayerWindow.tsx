  ...
  const wrapInShell = (
    ...
    <div className="mp-shell" style={shellStyle}>
      <style>{`
        ...
        .mp-shell [role="textbox"]:focus { box-shadow: 0 0 0 2px var(--ww-hue-2, var(--ww-hue-2, #0072b2)) inset; }
      `}</style>
      ...
      <div style={{
        ...
        {view.error && (
          <div role="alert" style={{
            ...
            fontSize: 16,
            lineHeight: "20px",
            color: "var(--ww-hue-1, var(--ww-hue-1, #d72229))",
            border: "1.5px solid var(--ww-hue-1, var(--ww-hue-1, #d72229))",
            borderRadius: 4,
            padding: "8px 12px",
            background: "#F8F2E9",
          }}>
          ...
          <div style={{ alignSelf: "stretch", display: "flex", gap: 10, height: 71 }}>
            ...
            <button
              ...
              style={{
                flexGrow: 1,
                height: 71,
                background: "var(--ww-hue-1, var(--ww-hue-1, #d72229))",
                border: "2px solid #231F20",
                borderRadius: 4,
                fontFamily: FONT_FAMILY,
                fontStyle: "italic",
  ...
  const shareSection = isHost ? (
    <button
      ...
      style={{
        alignSelf: "stretch",
        height: 56,
        background: shareFlash ? "#231F20" : "var(--ww-hue-2, var(--ww-hue-2, #0072b2))",
        border: "2px solid #231F20",
        borderRadius: 4,
        fontFamily: FONT_FAMILY,
        fontWeight: 400,
            ...
            return (
              <button
                ...
                style={{
                  ...
                  outline: selected ? "2px solid var(--ww-hue-1, var(--ww-hue-1, #d72229))" : "none",
  ...
  const startButton = isHost ? (
    <button
      ...
      style={{
        alignSelf: "stretch",
        height: 80,
        background: startDisabled ? "#544C4A" : "var(--ww-hue-1, var(--ww-hue-1, #d72229))",
        border: "2px solid #231F20",
        borderRadius: 4,
        fontFamily: FONT_FAMILY,
        fontStyle: "italic",
